...
function combine_plate(){
    ...
    document.getElementById("demo3").innerHTML = "3. Now make circular disk of the sample combined by putting in the brass tude";
    document.getElementById("btn3").style.display = "block";
}
function circular_disk(){
    document.getElementById("display_image").src = "../images/disk1.PNG";
    document.getElementById("btn3").disabled = true;   
     document.getElementById("demo4").innerHTML = "4. Now make cylinder by making a stack of disk."
}
